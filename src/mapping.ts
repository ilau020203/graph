...
//   DepositAdded(call.from,token.id,toDecimal(call.inputs._profit, 18),event?event.value:toDecimal(BigInt.zero(),0), toDecimal(call.inputs._amount, 9),call.block.timestamp,true);
